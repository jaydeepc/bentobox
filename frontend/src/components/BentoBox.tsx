...
const BentoBox = ({ isMinimized = false }: BentoBoxProps) => {
  ...
  return (
    <div className={`relative w-full max-w-4xl mx-auto ${isMinimized ? 'p-2' : 'p-8'}`}>
        ...
        <div className="relative h-full w-full bg-[#8B0000] rounded-2xl overflow-hidden">
          ...
          <div className="absolute inset-0 grid grid-cols-2 gap-4 p-4">
            ...
            <div className="grid grid-rows-3 gap-4">
              <motion.div
                className="relative bg-[#B22222] rounded-xl shadow-inner cursor-pointer overflow-hidden service-pulse"
              ...
              >
                <div className="absolute inset-0 flex flex-col items-center justify-center p-4">
                  ...
                  <h3 className="text-white text-lg font-semibold text-center service-text">Classification</h3>
                </div>
              </motion.div>

              {/* Placeholder for future service */}
              <motion.div
                className="relative bg-[#B22222] rounded-xl shadow-inner cursor-not-allowed overflow-hidden opacity-60"
                whileHover={{ scale: 1.02 }}
              >
            ...
            >
              <div className="absolute inset-0 flex flex-col items-center justify-center p-4">
                ...
                <h3 className="text-white text-xl font-semibold text-center service-text">Parsing</h3>
      ...
      {/* Chopsticks - Only show when not minimized */}
      {!isMinimized && (
